 ...
 *
 * The Slack authentication strategy authenticates requests by delegating to
 * Slack using the OAuth 2.0 protocol.
 *
 ...
 * @api public
 */
function SlackTokenStrategy(options, verify) {
  options = options || {};
  ...
  this.name = 'slack-token';
}

/**
 * Inherit from `OAuth2Strategy`.
 */
util.inherits(SlackTokenStrategy, OAuth2Strategy);
 ...
 * @api protected
 */
SlackTokenStrategy.prototype.authenticate = function(req, options) {
  options = options || {};
  var self = this;
 ...
 * @api protected
 */
SlackTokenStrategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('https://slack.com/api/users.identity?token=' + accessToken, '', function (err, body, res) {
 ...
 * @api private
 */
SlackTokenStrategy.prototype._loadUserProfile = function(accessToken, done) {
  var self = this;
...
/**
 * Expose `SlackTokenStrategy`.
 */
module.exports = SlackTokenStrategy;
